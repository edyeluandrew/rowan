...
import { formatXlm, formatCurrency } from '../utils/format'

const FILTER_OPTIONS = ['ALL', 'COMPLETE', 'PENDING_PAYMENT', 'REFUNDED', 'FAILED']

export default function History() {
  const { transactions, stats, loading, hasMore, loadMore } = useTransactions()
