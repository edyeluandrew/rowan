...
import {
  registerPlugin
} from "./chunk-NXETYX5E.js";
import {
  __toESM,
  require_dist,
  require_dist2,
  require_dist3
} from "./chunk-UNLJ2W5R.js";
...
var SecureStoragePlugin = registerPlugin("SecureStoragePlugin", {
  web: () => import("./web-7WPP2JPN.js").then((m) => new m.SecureStoragePluginWeb())
});
export {
  SecureStoragePlugin
};
//# sourceMappingURL=capacitor-secure-storage-plugin.js.map
