...
export const TRANSACTION_STATES = {
  ...
  FIAT_PAYOUT_SUBMITTED: { label: 'Payment Sent', color: 'text-rowan-orange', bg: 'bg-rowan-orange/20' },
  USER_CONFIRMATION_PENDING: { label: 'Confirming Receipt', color: 'text-rowan-orange', bg: 'bg-rowan-orange/20' },
  DISPUTE_OPENED:  { label: 'Dispute Opened', color: 'text-rowan-red', bg: 'bg-rowan-red/20' },
  DISPUTE_RELEASE_PENDING: { label: 'Releasing After Dispute', color: 'text-rowan-yellow', bg: 'bg-rowan-yellow/20' },
  DISPUTE_REFUND_PENDING: { label: 'Resolving Refund', color: 'text-rowan-yellow', bg: 'bg-rowan-yellow/20' },
...
export const FILTER_STATUSES = [
  ...
  { value: 'FIAT_PAYOUT_SUBMITTED', label: 'Payment Sent' },
  { value: 'USER_CONFIRMATION_PENDING', label: 'Confirming Receipt' },
