...
# Public key may be shared; the SECRET key must NEVER be committed.
# Set the secret only in your deployment environment / secrets manager.
MARKET_MAKER_PUBLIC_KEY=G...your-market-maker-public-key...
MARKET_MAKER_SECRET_KEY=__SET_IN_ENVIRONMENT_DO_NOT_COMMIT__

# Escrow Account (for XLM deposits)
ESCROW_PUBLIC_KEY=G...your-escrow-public-key...
ESCROW_SECRET_KEY=__SET_IN_ENVIRONMENT_DO_NOT_COMMIT__
